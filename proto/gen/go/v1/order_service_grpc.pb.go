...
const (
	OrderService_CreateOrder_FullMethodName = "/api.v1.OrderService/CreateOrder"
	OrderService_GetOrder_FullMethodName    = "/api.v1.OrderService/GetOrder"
	OrderService_DeleteOrder_FullMethodName = "/api.v1.OrderService/DeleteOrder"
)
...
type OrderServiceClient interface {
	...
	// 删除订单
	DeleteOrder(ctx context.Context, in *DeleteOrderRequest, opts ...grpc.CallOption) (*OperateResult, error)
}
...
func (c *orderServiceClient) DeleteOrder(ctx context.Context, in *DeleteOrderRequest, opts ...grpc.CallOption) (*OperateResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	// 删除订单
	DeleteOrder(context.Context, *DeleteOrderRequest) (*OperateResult, error)
...
func (UnimplementedOrderServiceServer) DeleteOrder(context.Context, *DeleteOrderRequest) (*OperateResult, error) {
